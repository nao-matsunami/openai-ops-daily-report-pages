# OpenAI Ops Public Report - 2026-09-10
...
| openai_github_org | 検証待ち | 20260907 | 3 | 20260907 | 20260910 | 公式情報の本文、取得ステータス、判断理由、推奨アクションのいずれかが変化した場合に詳細確認する | [OpenAI · GitHub](https://github.com/openai) / [OpenAI · GitHub](https://api.github.com/orgs/openai/repos) / [OpenAI · GitHub](https://developers.openai.com/llms.txt) |
